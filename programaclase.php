      ...
      <div class="row py-5">
        <div class="mx-auto col-lg-6">
          <form action="resultados.php">
            ...
            <div class="form-group"><select size="4" multiple="" class="form-control" name="asignatura">
                <option value="matematica">Matemática</option>
                <option value="quimica">Química</option>
                <option value="ingles">Inglés</option>
                <input value="¡Programa una clase ahora mismo!" type="submit" class="btn btn-outline-primary" href="resultados.php">
              </select></div>
          </form>
        </div>
      </div>
