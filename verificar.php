...
$sql = "SELECT id, nombre, asignatura, carrera, universidad, descripcion, precio, imagen FROM tutor WHERE id = '$id'";
...
?>
  ...
  <div class="">
    <div class="container">
      <div class="row border border-secondary rounded py-5" style="border-radius: 20px;">
        ...
        <div class="col-md-6 col-8 d-flex flex-column justify-content-center p-3 order-1 order-md-2">
          ...
          <h3>
            <?php echo $record['carrera'] ?>
          </h3>
          <h3>
            <?php echo $record['universidad'] ?>
          </h3>
          <p class="lead">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group w-100">
            <div class="w-100">
            <form method='request' action='succesfulclass.php'>
                <h3>Escoge un día:</h3><select name="dia" size="4" multiple="" class="form-control text-left w-100 mt-2">
            ...
            <div class="w-100 mt-2">
              ...
              <select name="hora" size="4" multiple="" class="form-control w-100">
                ...
                <option value="15" class="w-100">3:00 PM</option>
                <option value="16">4:00 PM</option>
                <option value="17">5:00 PM</option>
                <option value="18">6:00 PM</option>
              </select><input type="submit" name="id" value="<?php echo $id ?>" class="btn btn-primary mb-3 my-2" href="successfulclass.php">Enviar </button></div></form>
          </div>
        </div>
      </div>
    </div>
